...
extension UITextField {
    ...
    public enum UITextFieldTweenProperty: TweenableProperty {
        ...
        public static func interpolate(from startValue: UITextFieldTweenProperty, to endValue: UITextFieldTweenProperty, withEase ease: Ease,
            ...
            case let (.minimumFontSize(start), .minimumFontSize(end)):
                return .minimumFontSize(CGFloat.interpolate(from: start, to: end, withEase: ease, elapsed: elapsed, duration: duration))
            default:
                return startValue
            }
        }
